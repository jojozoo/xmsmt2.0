	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="image" class="text" value="${productChannel.image}" maxlength="200" title="${message("admin.product.imageTitle")}" />
				...
				<td>
					<select name="templateId">
						[#list templates as template]
							<option value="${template.id}" [#if productChannel.templateId == template.id] selected="selected"[/#if] >${template.name}</option>
						[/#list]
					</select>
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" id="selectedProductCategoryvalue" class="text" maxlength="200" title="搜索结果并入品牌筛选中" />
			...
			<tr class="productCategorys">
				...
				<td>
					[#list productChannel.productCategorys as productCategory]
						<label>
							<input type="checkbox" name="productCategoryIds" value="${productCategory.id}" checked="checked" />${productCategory.name}
						</label>
					[/#list]
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" id="selectedTenantCategoryvalue" class="text" maxlength="200" title="搜索结果并入品牌筛选中" />
			...
			<tr class="tenantCategorys">
				...
				<td>
					[#list productChannel.tenantCategorys as tenantCategory]
						<label>
							<input type="checkbox" name="tenantCategoryIds" value="${tenantCategory.id}" checked="checked" />${tenantCategory.name}
						</label>
					[/#list]
				</td>
			</tr>
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" id="selectedArticleCategoryvalue" class="text" maxlength="200" title="搜索结果并入品牌筛选中" />
			...
			<tr class="articleCategorys">
				...
				<td>
					[#list productChannel.articleCategories as articleCategory]
						<label>
							<input type="checkbox" name="articleCategoryIds" value="${articleCategory.id}" checked="checked" />${articleCategory.name}
						</label>
					[/#list]
				</td>
			</tr>
