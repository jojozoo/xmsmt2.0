...
<body>
	...
	<table class="input tabContent">
		...
		<tr>
			<td>
			<iframe name="kuaidi100" src="${deliveryTrackings}" width="600" height="380" marginwidth="0" 
	...
	<table class="input">
		<tr>
			...
			<td>
				<input type="button" class="button" value="${message("admin.common.back")}" onclick="location.href='shippedList.jhtml'" />
			</td>
		</tr>
	</table>
</body>
