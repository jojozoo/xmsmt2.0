...
<title>${message("admin.area.add")} - Powered By rsico</title>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="code" class="text" maxlength="6" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="telCode" class="text" maxlength="4" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<select id="status" name="status">
						<option value="none" selected="selected" >待开通</option>
