...
<title>${message("admin.setting.edit")} - Powered By rsico</title>
	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="enterpriseqq" class="text" value="${setting.enterpriseqq}" maxlength="100" />
				</td>
			</tr>
			<tr>
				<th>
		...
		<table class="input tabContent">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>提现手续费: 
				</th>
				<td>
					<input type="text" name="withdrawCashScale" class="text" value="${setting.withdrawCashScale}" maxlength="7" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>提现手续费加成: 
				</th>
				<td>
					<input type="text" name="withdrawCashAddScale" class="text" value="${setting.withdrawCashAddScale}" maxlength="7" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>分享佣金比例: 
				</th>
				<td>
