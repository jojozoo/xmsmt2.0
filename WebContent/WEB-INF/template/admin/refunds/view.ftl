...
<title>${message("admin.refunds.view")} - Powered By rsico</title>
...
<body>
	<form id="confirmRefundapplyForm" action="../order/confirmRefunds.jhtml" method="post">
	...
	<table class="input">
		...
		<tr>
			...
			<td colspan="3">
				...
				[#if refunds.status=='apply']
					<input type="submit" class="button" value="确认退款" id="refunds" />
				[/#if]
			</td>
		</tr>
	</table>
