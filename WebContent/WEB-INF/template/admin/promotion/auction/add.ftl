...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.promotion.auction.add")}
	</div>
		...
		<div class="tabContent">
			<table class="input">
				...
				<tr>
					...
					<td>
						<select name="classify" style="width:190px;">
							<option value="standard">标准拍</option>
							<option value="privilege">特权拍</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<textarea name="title" class="text"></textarea>
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr>
					...
					<td colspan="2">
						<input type="text" id="minimumPrice" name="minimumPrice" class="text" maxlength="16" title="未填写,则从0.00元开始"/>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td colspan="2">
						<input type="text" id="stepPrice" name="stepPrice" class="text" maxlength="16" title="未填写,则每次1.00元进行加价"/>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" name="bail" class="text" maxlength="9" title="未填写,则无保证金要求"/>
					</td>
				</tr>
				<tr>
					<th>
