...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.promotion.groupon.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="name">类型</a>
				</th>
				<th>
				...
				<th>
					<a href="javascript:;" class="sort" name="order">${message("Promotion.Status")}</a>
				</th>
				<th>
			...
			<tr>
				...
				<td>
					${message("Promotion.Status." + promotion.status)}
				</td>
				<td>
					<a href="edit.jhtml?redirect=view&id=${promotion.id}">[${message("admin.common.view")}]</a>
					[#if promotion.status == "submit" ]
					<a href="edit.jhtml?redirect=edit&id=${promotion.id}">[${message("admin.common.edit")}]</a>
					[/#if]
				</td>
			</tr>
			[/#list]
