...
public class HttpClientProxy {
	...
	private static class Tester {
		public static void main(String[] args) {
			...
			String temp = HttpClientProxy.doGet("http://61.147.68.123:7001/GetVideoAddressHandler?sxtid=1109160001",
							map);
			System.out.println("返回的消息是:" + temp);
			temp = HttpClientProxy.doGet("http://61.147.68.123:7001/GetVideoAddressHandler?sxtid=1109160001");
			System.out.println("返回的消息是:" + temp);
