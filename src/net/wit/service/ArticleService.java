...
public interface ArticleService extends BaseService<Article, Long> {
	 ...
	 * @return 仅包含已发布文章
	 */
	List<Article> findList(ArticleCategory articleCategory, List<Tag> tags, Tenant tenant, Area area, Integer count, List<Filter> filters, List<Order> orders);
	 ...
	 * @return 仅包含已发布文章
	 */
	List<Article> findList(ArticleCategory articleCategory, List<Tag> tags,Tenant tenant, Area area, Integer count, List<Filter> filters, List<Order> orders, String cacheRegion);
