...
public class RSAUtil {
	...
	static class Tester {
		public static void main(String[] args) throws Exception {
			System.out.println("------------未使用模和指数生成公钥和私钥的加解密--------------");
			HashMap<String, Object> map = RSAUtil.getKeys();
			//生成公钥和私钥
			RSAPublicKey publicKey = (RSAPublicKey) map.get("public");
			RSAPrivateKey privateKey = (RSAPrivateKey) map.get("private");
			String ming1 = "Hello World!";
			System.out.println("加密前："+ ming1);
			//加密后的密文
			String mi1 = RSAUtil.encryptByPublicKey(ming1, publicKey);
			System.out.println("加密后："+ mi1);
			//解密后的明文
			ming1 = RSAUtil.decryptByPrivateKey(mi1, privateKey);
			System.out.println("解密后："+ ming1);
			
			System.out.println("------------使用模和指数生成公钥和私钥的加解密--------------");
			//模
