 ...
 */
public class AlipayRefundNotify {
     ...
     * @return 验证结果
     */
    public static boolean verify(Map<String, String> params, String privateKey, String partner) {
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign, String privateKey) {
        ...
        isSign = MD5.verify(preSignStr, sign, privateKey, AlipayConfig.input_charset);
        return isSign;
    }
