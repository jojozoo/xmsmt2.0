...
import net.wit.plugin.alipayMobile.util.httpClient.HttpProtocolHandler;
import net.wit.plugin.alipayMobile.util.httpClient.HttpRequest;
import net.wit.plugin.alipayMobile.util.httpClient.HttpResponse;
import net.wit.plugin.alipayMobile.util.httpClient.HttpResultType;
...
public class AlipayRefund {
	...
	public static String buildRequestMysign(Map<String, String> sPara ,String key) {
        ...
        String mysign = MD5.sign(prestr, key, AlipayConfig.input_charset);
        return mysign;
    }
...
//        sPara.put("sign_type", AlipayConfig.sign_type);
    ...
    public static String buildRequest(Map<String, String> sParaTemp,
    		String strMethod, String strButtonName, String key) {
        //待请求参数数组
