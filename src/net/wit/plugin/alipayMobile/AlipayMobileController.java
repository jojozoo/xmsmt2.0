 ...
 * Controller - 支付宝(即时交易)
 */
@Controller("alipayMobileController")
@RequestMapping("/admin/payment_plugin/alipay_mobile")
public class AlipayMobileController extends BaseController {

	@Resource(name = "alipayDirectPlugin")
	private AlipayMobilePlugin alipayDirectPlugin;
	...
	public String setting(ModelMap model) {
		...
		return "/com/aok/plugin/alipayDirect/setting";
	}
